...
public final class OAuthUtil {
    ...
    public static void validateClientAndGrantType(ClientDetails client, OAuthProperties.GrantTypes grantType) {
        boolean valid;
    ...
    public static Map<String, String> extractClientFrom(HttpServletRequest request) {
        ...
        result.put(OAuthProperties.PARAM_CLIENT_ID, clientId);
        result.put(OAuthProperties.PARAM_CLIENT_SECRET, clientSecret);
        return result;
    }
